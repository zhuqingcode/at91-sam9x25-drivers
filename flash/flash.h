...
#define CFG_MAX_FLASH_SECT	135 	/* max number of sectors on one chip  8 boot sector (0x2000)
                                  + 127 main secotor (0x10000) */
...
#define CFG_CLK_MPLLIN 27000000
#define CFG_CLK_BUS 144000000
